...
"C:\Program Files\MariaDB 12.3\bin\mariadb.exe" -uparking_dba -p%MARIADB_DBA_PASSWORD% -h127.0.0.1 -P3305 -e "CALL neology_parking.maint_partitions_audit(202610);"
if errorlevel 1 (
